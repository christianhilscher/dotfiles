...
myCurrentWSColor = "#7aa6da" -- color of active workspace
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask .|. shiftMask , xK_d ), spawn $ "dmenu_run -i -nb '#191919' -nf '#7aa6da' -sb '#7aa6da' -sf '#191919' -fn 'NotoMonoRegular:bold:pixelsize=14'")
  ...
  , ((controlMask .|. mod1Mask , xK_Return ), spawn $ XMonad.terminal conf)
  , ((controlMask .|. mod1Mask , xK_h ), spawn $ "clipmenu")
  ...
  , ((0, xK_Print), spawn $ "scrot '%Y_%m_%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir screenshots)'")
